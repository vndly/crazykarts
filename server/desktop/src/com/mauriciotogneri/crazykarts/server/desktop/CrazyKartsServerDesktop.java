package com.mauriciotogneri.crazykarts.server.desktop;
...
import com.mauriciotogneri.crazykarts.server.core.Game.GameEvent;

public class CrazyKartsServerDesktop implements GameEvent
{
	public static void main(String[] args)
	{
		CrazyKartsServerDesktop crazyKartsServer = new CrazyKartsServerDesktop();
		crazyKartsServer.start(args);
	}
	...
	public void start(String[] args)
	{
		try
		{
			if (args.length > 0)
			{
				Properties properties = CrazyKartsServerDesktop.getProperties(args[0]);
